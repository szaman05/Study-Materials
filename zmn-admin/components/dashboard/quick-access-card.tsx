...
interface QuickAccessCardProps {
  title: string;
  description: string;
  icon: "package" | "users" | "chart" | string;
  iconComponent?: ReactNode; // Add this prop to accept Lucide icons
  actionText: string;
  href: string;
}
...
// Keeping the original getIcon function for backward compatibility
